...
- **Aligned 5-minute scheduler.** Polls on the next `:00`, `:05`, `:10`… boundary (+10s grace) once SNTP/HA time is valid, then fires the daily run when the scheduled time matches.
...
- **Schedule Hour / Minute** — daily start time (minute snaps to 5-minute steps)
- **Zone 1–5 Duration (min)**
